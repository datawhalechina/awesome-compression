...
![图4-13 对称线性量化](images/symmetric_linear.png)
...
![图4-14 卷积量化](images/conv_quantization.png)
...
![图4-15 逐张量量化](images/per-tensor.png)
...
![图4-16 逐张量量化与逐通道量化对比](images/channel_tensor.png)
...
![图4-17 VS-Quant](images/vs-quant.png)
...
![图4-18 不同的多级缩放方案](images/scale.png)
...
![图4-19 Rounding](images/rounding.png)
...
![图4-20 量化感知训练计算图](images/qat.png)
...
![图4-22 int4和fp4](images/int4_fp4.png)
...
![图4-23 二值量化示例](images/binarization.png)
...
![图4-24 二值量化示例](images/ternary.png)
