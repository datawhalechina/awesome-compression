...
![图4-10 计算量化后的矩阵](images/linear_2.png)
...
![图4-10 对称线性量化](images/symmetric_linear.png)
...
![图4-11 卷积量化](images/conv_quantization.png)
...
![图4-12 逐张量量化](images/per-tensor.png)
...
![图4-13 逐张量量化与逐通道量化对比](images/channel_tensor.png)
...
![图4-14 VS-Quant](images/vs-quant.png)
...
![图4-15 不同的多级缩放方案](images/scale.png)
...
![图4-16 Rounding](images/rounding.png)
...
![图4-17 量化感知训练计算图](images/qat.png)
...
![图4-19 int4和fp4](images/int4_fp4.png)
...
![图4-20 二值量化示例](images/binarization.png)
...
![图4-20 二值量化示例](images/ternary.png)
